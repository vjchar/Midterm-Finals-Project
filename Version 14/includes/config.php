...
const APP_VERSION = "Version 14";
defined("APP_URL") || define("APP_URL", "http://localhost/VJ-Car-Rental-v14");
...
defined("DB_NAME") || define("DB_NAME", "vj_car_rental_v14");
...
// Version 14 preserves the configurable cancellation/refund policy. Customer self-service cancellation
