...
<section class="content-section pt-0">
    <div class="container">
        <article class="operation-card">
            <span class="section-kicker">Version 14 cancellation policy</span>
            ...
            <div class="refund-policy-grid">
                ...
                <p><strong>Security Deposit Refund:</strong> returns the unused deposit balance after return inspection and final settlement.</p>
                <p><strong>Modification Refund:</strong> returns an actual overpayment when an approved pre-pickup modification lowers the amount owed.</p>
            </div>
        </article>
    </div>
</section>
