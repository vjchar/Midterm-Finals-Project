            ...
            <div class="col-lg-7">
                ...
                <?php if ($canModify): ?>
                    <article class="booking-management-panel">
                        ...
                        <p>Version 14 uses tracked requests instead of directly rewriting your reservation. Availability, maintenance, pricing, and any refund are recalculated server-side and reviewed before the authoritative booking changes.</p>
