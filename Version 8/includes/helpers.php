...
function user_facing_error_message(
    Throwable $exception,
    string $fallbackMessage = "The request could not be completed. Please try again.",
): string {
...
{
    return match ($status) {
        "confirmed", "completed", "approved", "available", "paid" => "success",
        "cancelled", "rejected", "unavailable", "failed" => "danger",
        "pending" => "warning",
        default => "secondary",
    };
}
