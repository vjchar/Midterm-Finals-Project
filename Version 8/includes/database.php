...
/**
 * Return the process-local PDO connection used by the Version 8 vehicle, authentication, booking, payment, favorites, and review services.
 */
...
require_once __DIR__ . "/repositories/favorite-repository.php";
