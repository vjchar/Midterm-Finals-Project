...
$activeNav = in_array($currentPage, ["vehicle-details.php", "compare.php", "favorites.php"], true)
    ? "vehicles.php"
    : $currentPage;
            ...
            <div class="mockup-menu" id="siteMenu">
                ...
                <?php if ($currentUser): ?>
                    <?php if ($isAdmin): ?>
                        ...
                        <a class="account-link" href="booking-management.php"><i class="bi bi-calendar-check" aria-hidden="true"></i><span>Booking Management</span></a>
                        <a class="account-link" href="payment-management.php"><i class="bi bi-credit-card" aria-hidden="true"></i><span>Payment Management</span></a>
                        <a class="account-link" href="review-management.php"><i class="bi bi-star" aria-hidden="true"></i><span>Review Management</span></a>
                    <?php else: ?>
                        ...
                        <a class="account-link" href="my-bookings.php"><i class="bi bi-calendar2-check" aria-hidden="true"></i><span>My Bookings</span></a>
                        <a class="account-link" href="favorites.php"><i class="bi bi-heart" aria-hidden="true"></i><span>Favorites</span></a>
                    <?php endif; ?>
