...
if ($availabilityPickupDate !== "" || $availabilityReturnDate !== "") {
    if (
        ...
        $availabilityFilterMessage =
            "Choose both dates to filter by availability.";
    }
}
...
if ($availabilityStart && $availabilityEnd) {
    $filteredVehicles = array_values(
        array_filter(
            $filteredVehicles,
            static fn(array $catalogVehicle): bool => vehicle_available(
...
<section class="content-section fleet-page">
    <div class="container">
        ...
        <?php if ($availabilityFilterMessage !== ""): ?>
            <div class="availability-inline <?= $availabilityStart && $availabilityEnd ? "is-success" : "is-error" ?>" role="status">
                <i class="bi bi-calendar-check"></i>
                <span><?= escape_html($availabilityFilterMessage) ?></span>
            </div>
        <?php endif; ?>
