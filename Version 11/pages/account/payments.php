...
if ($_SERVER["REQUEST_METHOD"] === "POST" && $selectedBooking) {
    ...
    try {
        ...
        flash(
            "success",
            $submittedPaymentType === "extension"
                ? "Extension payment submitted for administrator verification."
                : "Payment submitted. Continue by uploading your required documents.",
        );
        ...
        <?php if ($journey): ?>
            ...
            <?php else: ?>
                <article class="journey-next journey-next--primary">
                    ...
                    <div class="journey-next__body"><span class="section-kicker">Step 2 of 5</span><h2>Complete Payment</h2><p>Submit the required security deposit for booking <?= escape_html($selectedBooking["reference"]) ?>. After submission, we’ll take you directly to document upload.</p></div>
                </article>
            <?php endif; ?>
        <?php endif; ?>
                        ...
                        <article class="operation-card">
                            ...
                            <?php if (
                                (int) $paymentSummary["deposit_due"] +
                                    ...
                                    (int) $paymentSummary["extension_due"] === 0
                            ): ?>
