            ...
            <div class="col-lg-7">
                <article class="confirmation-card">
                    <div class="confirmation-vehicle">
                        ...
                        <div>
                            ...
                            <p>Your vehicle is reserved against the requested schedule while you complete payment and document verification.</p>
                        </div>
                    </div>
                ...
                <article class="next-steps-card">
                    ...
                    <ol>
                        ...
                        <li><span>3</span><div><strong>Documents</strong><p>Upload your driver’s license and government-issued ID.</p></div></li>
                        <li><span>4</span><div><strong>Verification</strong><p>The team verifies your payment and required documents.</p></div></li>
