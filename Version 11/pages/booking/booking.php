...
$selectedVehicleSlug =
    (string) ($_POST["vehicle"] ?? ($_GET["vehicle"] ?? "porsche-911"));
...
$selectedPickupMethod = (string) ($_POST["pickup_method"] ?? "Branch pickup");
    ...
    try {
        ...
        if ($requestedFormAction === "select_vehicle") {
            ...
            if ($requestedFormAction === "preview") {
                ...
                flash(
                    "success",
                    "Booking created. Upload your documents and submit the security deposit for verification.",
                );
                redirect(
...
$pageDescription =
    "Create a secure VJ Car Rental reservation with server-verified availability and pricing.";
...
<section class="page-hero page-hero--compact pattern-layer">
    <div class="container">
        ...
        <p>
            ...
            availability and final pricing before the reservation is saved.
        </p>
    </div>
</section>
