...
<section class="page-hero pattern-layer">
    <div class="container">
        <span class="section-kicker">PHP-powered fleet finder</span>
        <h1>Find your exact car</h1>
        <p>
            Filter by category, brand, seating, fuel, price, and rental dates.
            Every result is calculated securely by PHP using current database records.
        </p>
    </div>
</section>
...
<section class="content-section fleet-page">
    <div class="container">
        ...
        <div class="fleet-results-header">
            ...
            <span>Database-powered fleet &bull; availability checked by PHP</span>
        </div>
