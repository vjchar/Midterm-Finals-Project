    ...
    <div class="container">
        <article class="invoice-card">
            ...
            <div class="invoice-refunds">
                ...
                <table class="invoice-table"><thead><tr><th>Refund</th><th>Status</th></tr></thead><tbody>
                <?php foreach ($refunds as $refund): ?><tr><td><?= money((int) $refund["amount"]) ?><small><?= $refund["processed_at"] ? " · " . date("M j, Y", strtotime($refund["processed_at"])) : "" ?><?= $refund["reference_number"] ? " · " . escape_html($refund["reference_number"]) : "" ?></small></td><td><?= escape_html(ucfirst($refund["status"])) ?></td></tr><?php endforeach; ?>
                </tbody></table>
            </div>
            <?php endif; ?>
