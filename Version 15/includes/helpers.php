 ...
 * FILE PURPOSE: General reusable helper functions used across the application.
 * USED BY: Pages, services, and layout files.
 * RESPONSIBILITY: Provides cross-cutting utilities such as escaping, redirects, formatting, CSRF helpers, validation helpers, status labels, and common response helpers.
 *
