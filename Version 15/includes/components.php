...
/**
 * FILE: includes/components.php
 * FILE PURPOSE: Reusable server-rendered UI components.
 * USED BY: Pages that need shared vehicle cards, booking progress, or other repeated presentation blocks.
 * RESPONSIBILITY: Keeps repeated presentation markup in reusable functions so page files stay smaller and more consistent.
 *
