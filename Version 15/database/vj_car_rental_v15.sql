-- FILE: database/vj_car_rental_v15.sql
-- PURPOSE: MySQL/MariaDB schema and reference-data dump for VJ Car Rental.
-- USAGE: Imported through phpMyAdmin/MySQL to create the database tables, keys, constraints, and baseline reference data required by the PHP application.
-- Maintenance: review schema changes carefully before importing into an existing database.

-- VJ Car Rental Version 15 — database schema and reference data
-- Import this file once with phpMyAdmin. Version 15 preserves the established reference data; refunds, settlements, modifications, cancellations, drafts, and operational customer data remain empty.

-- MariaDB dump 10.19  Distrib 10.4.32-MariaDB, for Win64 (AMD64)
--
-- Host: 127.0.0.1    Database: vj_car_rental_v15
-- ------------------------------------------------------
...
--
-- Current Database: `vj_car_rental_v15`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `vj_car_rental_v15` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;

USE `vj_car_rental_v15`;
...
--
-- Dumping events for database 'vj_car_rental_v15'
--

--
-- Dumping routines for database 'vj_car_rental_v15'
--
